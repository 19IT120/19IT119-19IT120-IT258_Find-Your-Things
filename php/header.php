...
<head>
    ...
    <?php if(isset($title)){ ?>
        <title><?php echo $title; ?>Find your things</title>
    <?php }else{ ?>
            ...
            <div class="col-md-2">
                <?php
                    if(!empty($header[0]['site_logo'])){ ?>
                        <a href="<?php echo $hostname; ?>" class="logo-img"><img src="images/1606687006shopping-logo.png<?php echo $header[0]['site_logo']; ?>" alt=""></a>
                    <?php }else{ ?>
